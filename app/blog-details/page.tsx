...
export const metadata: Metadata = {
  title: "Chi tiết tin tức| Puni Spa",
          ...
          <div className="w-full px-4 lg:w-8/12">
            <div>
              <h2 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                30+ Câu hỏi mà mẹ bầu nào cũng thắc mắc sau sinh
              </h2>
              ...
              <div>
                <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  Sau khi sinh các mẹ thường có vô vàn thắc mắc liên quan đến vấn đề mẹ và bé. Hiểu được nỗi lo lắng của mẹ, <strong className="text-primary dark:text-white">PuniSpa</strong> tổng hợp chia sẻ với các mẹ các câu hỏi mà mẹ bầu nào cũng thắc mắc sau sinh. Mời các mẹ theo dõi chi tiết phía dưới nhé.
                </p>
